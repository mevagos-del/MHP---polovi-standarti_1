...
type Props = {
  ...
  onPlanSaved: () => void;
  onPlanningMonthChange: (monthCode: string) => void;
...
function PlanningForm({ dictionaries, onPlanSaved, onPlanningMonthChange, onSelectionChange }: Props) {
  ...
  useEffect(() => {
    onPlanningMonthChange(form.monthCode);
  }, [form.monthCode, onPlanningMonthChange]);
